...
export function DeepTraceBanner({
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-amber-500/25 bg-amber-500/[0.04] p-5">
      <div className="absolute left-0 top-0 bottom-0 w-[3px] bg-gradient-to-b from-amber-400 to-amber-500" />

      <div className="relative flex items-start gap-4 flex-wrap pl-2">
        <div className="size-10 grid place-items-center rounded-lg bg-amber-500/15 border border-amber-500/30 text-amber-300 shrink-0">
        ...
        <button
          onClick={onRun}
          disabled={running}
          className="btn px-4 py-2 bg-amber-500/90 text-ink-950 hover:bg-amber-400 font-semibold text-[13px] shrink-0"
        >
          {running ? (
            <>
